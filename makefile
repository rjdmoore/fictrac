...
INCL := -I $(INCLDIR)
LDFLAGS := -L $(LIBDIR)
LDLIBS := -lfictrac -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_video -lboost_log -lboost_log_setup -lboost_filesystem -lboost_system -lboost_thread -lpthread
